...
## Project Structure
    ...
    ├── movingforwardfarmll_38897  # Django project configurations
...
1. Clone this repo and `cd movingforwardfarmll_38897`
...
2. Clone this repo and `cd movingforwardfarmll_38897`
